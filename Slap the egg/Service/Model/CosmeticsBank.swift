...
struct PowerUpsAvailable {
    static let powerUps: [PowerUp] = [
        PowerUp(name: "Double Points", description: "For one try, your egg shell earnings are doubled", type: .multiplicate, value: 2, shopAvailable: true),
        ...
        PowerUp(name: "One more Life", description: "In the next session, if the egg gets cracked it ignores one time", type: .revive, value: 1),
...
//        BackgroundModel(name: "Bricks", image: "bricksBackground"),
